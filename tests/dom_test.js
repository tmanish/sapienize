...
assert(/STYLE/.test(scoreHtml) && /<svg/.test(scoreHtml), "style-heuristic dial renders without authorship language");
assert(typeof dom.window.sapienize.analyze === "function" && typeof dom.window.sapienize.createVoiceProfile === "function", "provider-neutral core API is available in the standalone browser build");
